...
export default function App() {
  ...
  return (
    <div style={{
      ...
      background: `url('https://images.unsplash.com/photo-1501785888041-af3ef285b470?auto=format&fit=crop&w=1500&q=80'), url('https://images.unsplash.com/photo-1500534314209-a25ddb2bd429?auto=format&fit=crop&w=1500&q=80') center center/cover no-repeat fixed`,
      padding: 0,
      margin: 0
    }}>
      <div style={{
        ...
        background: 'none', // remove white/transparency block
        padding: 40,
        borderRadius: 0,
        ...
        <div style={{width:'100%',display:'flex',flexDirection:'column',alignItems:'center',justifyContent:'center'}}>
          <div style={{width:'100%',maxWidth:500,display:'flex',flexDirection:'column',alignItems:'center',justifyContent:'center'}}>
